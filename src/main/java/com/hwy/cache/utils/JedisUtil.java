package com.hwy.cache.utils;


import com.hwy.cache.common.Constant;
import com.hwy.cache.exception.CustomException;
...
public class JedisUtil {
    ...
    public static Object getObject(String key) {
        try (Jedis jedis = getJedisByInfo()) {
    ...
    public static Boolean exists(String key) {
        JedisShardInfo jedisShardInfo = new JedisShardInfo("47.101.154.117", 6379);
        jedisShardInfo.setPassword("hwy123456");
        jedisShardInfo.setSoTimeout(500);
        try (Jedis jedis = new Jedis(jedisShardInfo)) {
    ...
    public static Jedis getJedisByInfo() {
        JedisShardInfo jedisShardInfo = new JedisShardInfo("47.101.154.117", 6379);
        jedisShardInfo.setPassword("hwy123456");
        jedisShardInfo.setSoTimeout(500);
